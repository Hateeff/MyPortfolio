import memojiImage from '@/assets/images/sticker6.webp';
import Image from "next/image";
import ArrrowDown from '@/assets/icons/arrow-down.svg';
  ...
  return (
   ...
   <HeroOrbit size={800} rotation={-72}>
    ...
    <div className="container">
      ...
      <Image src={memojiImage} className='size-[140px]' alt="Memoji Computer"/>
    ...
    <p className='mt-4 text-center text-white/60 md:text-lg'>I help businesses create digital products that are both functional and beautiful.</p>
    </div>
